...
<p>Join our mailing list. Spread awareness and stay united against scams.</p>


</div>
    </div>
    <div id="mailingListContainer_T1764BC25025_Col01" class="sf_colsIn col-md-3" data-sf-element="Column 2" data-placeholder-label="Column 2"><div class='text-center text-md-right pt-3'><a href="fight.php" class="btn btn-outline-light">Join Mailing List</a>
...
<!-- Modal -->
<div class="modal fade text-dark" id="mailingList" tabindex="-1" role="dialog" aria-labelledby="mailingList" aria-hidden="true">
<form>
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<p class="text-center">Stay current. Get the latest scam alerts & news in your email or WhatsApp.<br />And remember to share these important updates with your loved ones to help fight scams too!</p>
		<div class="mailing-list text-uppercase">
			  <div class="row">
				<div class="col-md-6">
			  ...
			  <div class="form-group">
				...
				<input type="number" class="form-control rounded-0" id="mobileNo" aria-describedby="emailHelp">
			  </div>
			  <div class="form-group">
		...
		<div class="modal-footer">
			<div class="text-center">
			    <button type="submit" class="btn btn-primary">Join Mailing List</button>
			  </div>	
		</div>
      </div>
    </div>
...
<a href="rez/videos.php" title="Videos" class="text-muted">Videos</a>
    ...
    <li>
    <h5><a href="../types-of-scams.php" title="Types of Scams"></a><a href="rez/news.php" title="Media News">Media News</a></h5>
    </li>
    <li>
...
<span class="d-none d-sm-block">© 2020 Scam Alert Singapore  | <a href="privacy-cookie-policy.php" title="Privacy Statements">Privacy &amp; Cookie Policy</a>&nbsp; |  <a href="terms-of-use.php" title="Terms of Use">Terms of Use</a></span>
    ...
    <div id="footer_T1764BC25053_Col01" class="sf_colsIn col-md-3" data-sf-element="Column 2" data-placeholder-label="Column 2"><div class='text-center text-md-right'><a href="fight.php" class="btn btn-outline-primary">
Be An Advocate
</a>
...
$.src="https://v2.zopim.com/?66KYYOZoqvfwClUn9OjwM8wBFhr1avAC";z.t=+new Date;$.
...
;(function() {
                        function loadHandler() {
                            ...
                            hf.value += ';Telerik.Sitefinity.Resources, Version=10.2.6603.0, Culture=neutral, PublicKeyToken=b28c218413bdf563:en:2d5b3488-fb7a-434a-a4cc-a5adec19f7a1:7a90d6a';
                            Sys.Application.remove_load(loadHandler);
                        };
                        Sys.Application.add_load(loadHandler);
                    })();//]]>
</script>
</form><script type="text/javascript" src="Bootstrap/assets/dist/js/jquery-3.2.1.min.js"></script>
<script type="text/javascript" src="Bootstrap/assets/dist/js/popper.min.js"></script>
<script type="text/javascript" src="Bootstrap/assets/dist/js/bootstrap.js"></script>
<script type="text/javascript" src="Bootstrap/assets/dist/js/functions.js"></script>
<script type="text/javascript" src="Bootstrap/assets/dist/js/jquery-eu-cookie-law-popup.js"></script>
<script type="text/javascript" src="../s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5b963f5c1f7e4fbd"></script>
<script type="text/javascript">
$(document).ready(function(){
  $(document).on('click','#copy-btn', function(){
    ...
    copytext('http://ccid.rmp.gov.my/semakmule/');  
...
function copytext(text) {
    ...
    checkMalaysianAcct.focus(); //SET FOCUS BACK to MODAL
}
...
<!-- Mirrored from www.scamalert.sg/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 May 2021 11:24:36 GMT -->
</html>