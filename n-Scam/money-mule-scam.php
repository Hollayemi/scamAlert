...
<main role="main"> 
    ...
    <script type="text/javascript">
        $(function () {
            $(document).prop('title', 'Money Mule Scam');
        });
    </script>
                    ...
                    <div class="tab-content mt-5" id="myTabContent">
                        <div id="content1" class="tab-pane fade active" role="tabpanel" aria-labelledby="content1-tab">
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsLookOutId_Less" style="display:none;">
                                <div><ul>
    <li>People offering commission for doing little other than transferring money</li>
    <li>People you have never met asking for personal details</li>
    <li>Employers with no street address. They may be trying to avoid being tracked down</li>
</ul></div>
    ...
    <li>Employers with no street address. They may be trying to avoid being tracked down</li>
                        ...
                        <div id="content2" class="tab-pane fade" role="tabpanel" aria-labelledby="content2-tab">
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsProtectId_Less" style="display:none;">
                                <div><ul>
    <li>Never give out personal particulars or bank account details to people you have never met</li>
    <li>Decline all requests by an online acquaintance for money transfers. You might be unwittingly committing a crime by laundering money for another party</li>
    <li>If you suspect that you have received money in your account in the above circumstances, report it to the bank and the Police immediately. If the money is still in your account, do not deal with it</li>
    <li>Ensure that your bank account is used only for your personal banking needs</li>
</ul></div>
                                <div class="text-center">
...
<div class="stories overflow-hide">
    ...
    <?php
        ...
        foreach($allTypeIds as $allTypeId){
            $storyIdsDetails     =   fetchAllSories($conn,$allTypeId)
    ?>
