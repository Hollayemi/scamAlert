...
<main role="main"> 
    ...
    <script type="text/javascript">
        $(function () {
            $(document).prop('title', 'Wangiri Scam');
        });
    </script>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-right order-lg-2">
                    <img class="img-fluid" src="../default-album/top-banners/wangiri-scam25d4.png?sfvrsn=58417a11_2" alt="Wangiri Scam" />
                </div>
                <div class="col-md-6 my-auto order-lg-1 text-center text-sm-left">
                    <h1>
                        WHAT IS A Wangiri Scam? <br />
                    </h1>
                    <p class="lead"><p>This scam gets its name from the Japanese word Wangiri &mdash; 'wan' means 'one' and 'giri' means 'hang-up'. Victims receive a phone call from an overseas number, which rings just once. If they return the call, they will hear an advertisement for a subscription to a premium chat line or internet services. Victims are charged a premium for this call. </p>
<p>In another variation of this scam, the caller, claiming to be an official, leaves a voice message informing the victim that there has been an emergency to which they must respond by calling them back. The latest version involves WhatsApp messages with contact attachments. Victims incur a hefty fee when they call that contact.</p></p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="tab-content mt-5" id="myTabContent">
                        <div id="content1" class="tab-pane fade active" role="tabpanel" aria-labelledby="content1-tab">
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsLookOutId_Less" style="display:none;">
                                <div><ul>
    <li>Calls from unknown overseas numbers that only ring once. Sometimes, these numbers are just slightly different from each other. This could indicate a bank of automated machines making random calls</li>
</ul></div>
    ...
    <li>Calls from unknown overseas numbers that only ring once. Sometimes, these numbers are just slightly different from each other. This could indicate a bank of automated machines making random calls</li>
                        ...
                        <div id="content2" class="tab-pane fade" role="tabpanel" aria-labelledby="content2-tab">
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsProtectId_Less" style="display:none;">
                                <div><ul>
    <li>Do not return the call</li>
    <li>Look up numbers on the internet to check for reports of scams from that number</li>
</ul></div>
                                <div class="text-center">
