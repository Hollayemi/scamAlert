...
<main role="main"> 
    ...
    <script type="text/javascript">
        $(function () {
            $(document).prop('title', 'Kidnap Scam');
        });
    </script>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-right order-lg-2">
                    <img class="img-fluid" src="../default-album/top-banners/kidnap-scame223.png?sfvrsn=ed30c373_2" alt="Kidnap Scam" />
                </div>
                <div class="col-md-6 my-auto order-lg-1 text-center text-sm-left">
                    <h1>
                        WHAT IS A Kidnap Scam? <br />
                    </h1>
                    <p class="lead"><p>Victims get a call from someone claiming that a loved one of the victim has been kidnapped. During the call, victims might hear screaming or crying in the background.</p></p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row no-gutters-border py-5">
                        <div class="col-md-6 py-3 border-white">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <h2><span class="timer count-title count-number" data-to="2" data-speed="1500"></span></h2>
                        ...
                        <div class="col-md-6 py-3">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <h2>$<span class="timer count-title count-number" data-to="6300000.00" data-speed="3000"></span></h2>
                    ...
                    <div class="tab-content mt-5" id="myTabContent">
                        <div id="content1" class="tab-pane fade active" role="tabpanel" aria-labelledby="content1-tab">
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsLookOutId_Less" style="display:none;">
                                <div><ul>
    <li>Scammers who claim to know your loved ones' names, but refuse to give you descriptive details</li>
</ul></div>
    ...
    <li>Scammers who claim to know your loved ones' names, but refuse to give you descriptive details</li>
                        ...
                        <div id="content2" class="tab-pane fade" role="tabpanel" aria-labelledby="content2-tab">
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsProtectId_Less" style="display:none;">
                                <div><ul>
    <li>Remain calm and tell the caller to identify the kidnapped person</li>
    <li>Do not transfer money to the caller</li>
    <li>Contact your loved one immediately to confirm their safety and whereabouts. You can do this while still on the phone with the "kidnapper"</li>
</ul>
<p>
To provide any information related to such crimes, please call the Police hotline at 1800-255-0000, or submit it online at www.police.gov.sg/iwitness. For urgent Police assistance, please dial '999'.You may also call the Anti-Scam Helpline at 1800-722-6688 for scam-related advice</p></div>
                                <div class="text-center">
    ...
    <li>Remain calm and tell the caller to identify the kidnapped person</li>
    <li>Do not transfer money to the caller</li>
    <li>Contact your loved one immediately to confirm their safety and whereabouts. You can do this while still on the phone with the</div>
                                <div class="text-center">
