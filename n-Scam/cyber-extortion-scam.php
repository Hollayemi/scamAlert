...
<main role="main"> 
    ...
    <script type="text/javascript">
        $(function () {
            $(document).prop('title', 'Cyber Extortion Scam');
        });
    </script>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-right order-lg-2">
                    <img class="img-fluid" src="../default-album/top-banners/cyber-extortion-scam2cc7.png?sfvrsn=50fc7532_2" alt="Cyber Extortion Scam" />
                </div>
                <div class="col-md-6 my-auto order-lg-1 text-center text-sm-left">
                    <h1>
                        WHAT IS A Cyber Extortion Scam? <br />
                    </h1>
                    <p class="lead"><p>Scammers befriend victims online and then coax them into performing an indecent act on camera. Afterwards, the scammers use the video footage or images of the act to extort money from the victims.</p></p>
                </div>
            </div>
        </div>
    </div>
...
<div class="counter">
                    ...
                    <div class="tab-content mt-5" id="myTabContent">
                        <div id="content1" class="tab-pane fade active" role="tabpanel" aria-labelledby="content1-tab">
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsLookOutId_Less" style="display:none;">
                                <div><ul>
    <li>The people you befriend online. Scammers often prey on emotions to convince victims to do things they would not otherwise do.</li>
</ul></div>
    ...
    <li>The people you befriend online. Scammers often prey on emotions to convince victims to do things they would not otherwise do.</li>
                        ...
                        <div id="content2" class="tab-pane fade" role="tabpanel" aria-labelledby="content2-tab">
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsProtectId_Less" style="display:none;">
                                <div><ul>
    <li>Remember that whatever happens on the Internet is likely to stay on the Internet and is accessible to everyone.</li>
    <li>Do not trust strangers with photos or videos of yourself.</li>
    <li>Do not agree to requests that might put you in a compromising position, such as performing indecent acts in front of a webcam. It is very likely that you are being recorded.</li>
    <li>Never give your personal details to strangers online.</li>
</ul></div>
                                <div class="text-center">
    ...
    <li>Remember that whatever happens on the Internet is likely to stay on the Internet and is accessible to everyone.</li>
    <li>Do not trust strangers with photos or videos of yourself.</li>
    <li>Do not agree to requests that might put you in a</div>
                                <div class="text-center">
