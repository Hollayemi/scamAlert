...
?>
 <main role="main"> 
    ...
    <script type="text/javascript">
        $(function () {
            $(document).prop('title', 'Apple Scam');
        });
    </script>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-right order-lg-2">
                    <img class="img-fluid" src="../default-album/top-banners/apple-scam2db7.png?sfvrsn=530fb607_2" alt="Apple Scam" />
                </div>
                <div class="col-md-6 my-auto order-lg-1 text-center text-sm-left">
                    <h1>
                        What Is An Apple Scam? <br />
                    </h1>
                    <p class="lead">In this scam, scammers tell victims that they or their loved ones are about to experience misfortune, which they can prevent by performing a ritual. As part of the ritual, money or valuables are placed in a plastic bag or container. Victims are told that the bag or container can only be opened a few days later or the ritual will not work. When the proper time has passed, victims open the bag to find that the valuables have been replaced by worthless items like fruit, newspapers or sugar.</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="tab-content mt-5" id="myTabContent">
                        <div id="content1" class="tab-pane fade active" role="tabpanel" aria-labelledby="content1-tab">
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsLookOutId_Less" style="display:none;">
                                <div><ul>
    <li>People who ask you to show or part with your valuables.</li>
    <li>People who prey on your emotions and superstitions.</li>
</ul></div>
    ...
    <li>People who prey on your emotions and superstitions.</li>
                        ...
                        <div id="content2" class="tab-pane fade" role="tabpanel" aria-labelledby="content2-tab">
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsProtectId_Less" style="display:none;">
                                <div><ul>
    <li>Always keep your valuables safe and within easy reach.</li>
    <li>Always be wary of people who ask you to hand them your cash or valuables.</li>
</ul></div>
                                <div class="text-center">
