...
<main role="main"> 
    ...
    <script type="text/javascript">
        $(function () {
            $(document).prop('title', 'Inheritance Scam');
        });
    </script>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-right order-lg-2">
                    <img class="img-fluid" src="../default-album/top-banners/inheritance-scamd596.png?sfvrsn=a1da7ab1_2" alt="Inheritance Scam" />
                </div>
                <div class="col-md-6 my-auto order-lg-1 text-center text-sm-left">
                    <h1>
                        WHAT IS AN Inheritance Scam? <br />
                    </h1>
                    <p class="lead"><p>Victims receive a letter, call or email stating that they have been left a large fortune. However, to have the funds released, victims must first pay the administration fees and taxes.</p></p>
                </div>
            </div>
        </div>
    </div>
...
<div class="counter">
                    ...
                    <div class="row no-gutters-border py-5">
                        <div class="col-md-6 py-3 border-white">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <h2><span class="timer count-title count-number" data-to="4" data-speed="1500"></span></h2>
                        ...
                        <div class="col-md-6 py-3">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <h2>$<span class="timer count-title count-number" data-to="1329650.00" data-speed="3000"></span></h2>
                    ...
                    <div class="tab-content mt-5" id="myTabContent">
                        <div id="content1" class="tab-pane fade active" role="tabpanel" aria-labelledby="content1-tab">
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsLookOutId_Less" style="display:none;">
                                <div><ul>
    <li>Unexpected gifts of money and windfalls</li>
    <li>When you receive official-looking letters or emails, be sure to research the sender's identity before taking any action</li>
    <li>Correspondence that asks for your bank account details or personal information</li>
    <li>Bad grammar in an official email &mdash; this is a tell-tale sign of a scam</li>
</ul></div>
    ...
    <li>Bad grammar</div>
                        ...
                        <div id="content2" class="tab-pane fade" role="tabpanel" aria-labelledby="content2-tab">
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsProtectId_Less" style="display:none;">
                                <div><ul>
    <li>Ignore the correspondence. If something sounds too good to be true, it probably is</li>
    <li>Do not send money to strangers, even if they claim the money will be used to unlock a greater fortune</li>
    <li>Do not transfer money to anyone who requests it</li>
</ul></div>
                                <div class="text-center">
    ...
    <li>Ignore the correspondence. If something sounds too good to be true, it probably is</li>
    <li>Do not send money to strangers, even if they claim the money will be used to unlock a greater fortune</li>
    <li>Do not transfer money to anyone</div>
                                <div class="text-center">
