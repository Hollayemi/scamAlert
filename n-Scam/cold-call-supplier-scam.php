...
<main role="main"> 
    ...
    <script type="text/javascript" src="../ResourcePackages/Bootstrap/assets/dist/js/jquery-3.2.1.min.js"></script>
    <script type="text/javascript">
        $(function () {
            $(document).prop('title', 'Cold Call Supplier Scam');
        });
    </script>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-right order-lg-2">
                    <img class="img-fluid" src="../default-album/top-banners/cold-call-scamb3ed.png?sfvrsn=657279cc_2" alt="Cold Call Supplier Scam" />
                </div>
                <div class="col-md-6 my-auto order-lg-1 text-center text-sm-left">
                    <h1>
                        WHAT IS A Cold Call Supplier Scam? <br />
                    </h1>
                    <p class="lead"><p>This scam targets owners of trading firms. It usually begins with a call from a person overseas, who offers the company owner exclusive rights to sell a product in Singapore. After they accept the offer, the trading firm owner receives a large order for the product, which actually comes from the scammers. To fulfil those orders, the victim orders and pays for the items. The victim soon realises that the items will never arrive and the scammers have disappeared.</p></p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="tab-content mt-5" id="myTabContent">
                        <div id="content1" class="tab-pane fade active" role="tabpanel" aria-labelledby="content1-tab">
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsLookOutId_Less" style="display:none;">
                                <div><ul>
    <li>Strangers on the phone, particularly if they are overseas, offering an investment opportunity that sounds unusually attractive.</li>
</ul></div>
    ...
    <li>Strangers on the phone, particularly if they are overseas, offering an investment opportunity that sounds unusually attractive.</li>
                        ...
                        <div id="content2" class="tab-pane fade" role="tabpanel" aria-labelledby="content2-tab">
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsProtectId_Less" style="display:none;">
                                <div><ul>
    <li>Always check the credibility and identity of the person offering the opportunity before making a financial commitment. Research their company and address, especially if they are based overseas.</li>
    <li>Ask for an in-person meeting wherever possible.</li>
</ul></div>
                                <div class="text-center">
