...
<div class="counter">
                    ...
                    <div class="tab-content mt-5" id="myTabContent">
                        <div id="content1" class="tab-pane fade active" role="tabpanel" aria-labelledby="content1-tab">
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsLookOutId_Less" style="display:none;">
                                <div><ul>
    <li>Ads that reach out to you through social media, SMS or messaging apps or even cold calls</li>
    <li>Fake business websites might be created to convince you that they are legitimate</li>
    <li>Instant, fuss-free loan approvals</li>
    <li>Requests for fees to be transferred to them before they can process your loan application</li>
</ul></div>
    ...
    <li>Block and report the number on the platform that you receive the message</li>
    <li>Seek financial help from legitimate financial institutes registered with the Registry of Moneylenders at <a href="https://rom.mlaw.gov.sg/information-for-borrowers/list-of-licensed-moneylenders-in-singapore/" target="_blank">https://rom.mlaw.gov.sg/information-for-borrowers/list-of-licensed-moneylenders-in-singapore/</a></li>
</ul></div>
                                <div class="text-center">
