...
<main role="main"> 
    ...
    <script type="text/javascript">
        $(function () {
            $(document).prop('title', 'Car Rental Scam');
        });
    </script>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-right order-lg-2">
                    <img class="img-fluid" src="../default-album/top-banners/car-rental-scamcabe.png?sfvrsn=9a0a82c3_2" alt="Car Rental Scam" />
                </div>
                <div class="col-md-6 my-auto order-lg-1 text-center text-sm-left">
                    <h1>
                        WHAT IS A Car Rental Scam? <br />
                    </h1>
                    <p class="lead"><p>If an ad for a rental car seems too cheap to be true, then it's probably a scam. The car rental scam tricks victims into paying a deposit or the full rental fee before receiving the car. After payment has been made, victims find that the agency and car do not exist.</p></p>
                </div>
            </div>
        </div>
    </div>
...
<div class="counter">
                    ...
                    <div class="tab-content mt-5" id="myTabContent">
                        <div id="content1" class="tab-pane fade active" role="tabpanel" aria-labelledby="content1-tab">
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsLookOutId_Less" style="display:none;">
                                <div><ul>
    <li>Ads with generic photos. Car rental photos should correspond to the make and models advertised.</li>
    <li>A service advertised for much cheaper than the prevailing rate.</li>
</ul></div>
    ...
    <li>A service advertised for much cheaper than the prevailing rate.</li>
                        ...
                        <div id="content2" class="tab-pane fade" role="tabpanel" aria-labelledby="content2-tab">
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsProtectId_Less" style="display:none;">
                                <div><ul>
    <li>Only rent vehicles from reputable car rental companies. Check with ACRA to confirm that the company exists.</li>
    <li>Insist on documentation of the car rental details, especially of payment.</li>
    <li>Ask to see the vehicle and its identification documents to verify its ownership.</li>
</ul></div>
                                <div class="text-center">
    ...
    <li>Only rent vehicles from reputable car rental companies. Check with ACRA to confirm that the company exists.</li>
    <li>Insist on documentation of the car rental details, especially of payment.</li>
    <li>Ask to see the vehicle and its identification documents to verify its</div>
                                <div class="text-center">
